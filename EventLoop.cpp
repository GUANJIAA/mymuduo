...
// 防止一个线程创建多个EventLoop，相当于全局变量 thread_local
...
// 退出事件循环     1.loop在自己的线程冲调用quit    2.在非loop的线程中，调用loop的quit
void EventLoop::quit()
{
    quit_ = true;
...
void EventLoop::queueInLoop(Functor cb)
{
    ...
    // || callingPendFunctiors_的意思是：当前loop正在执行回调，但是loop又有了新的回调
